        ...
        <div class="bg-white rounded-lg border border-gray-100 p-6">
            <form method="post" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input name="id_photo_path" value="<?= htmlspecialchars($data['id_photo_path']) ?>" placeholder="e.g. /uploads/ids/guest_12_front.jpg" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm" />
                </div>
